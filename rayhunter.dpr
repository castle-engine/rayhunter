...
var
  ...
  OctreeMaxLeafItemsCount: integer = DefTriangleOctreeMaxLeafItemsCount;
...
const
  ...
  ( (Short:  #0; Long: 'scene-bg-color'; Argument: oaRequired3Separate),
    ...
    (Short:  #0; Long: 'octree-max-leaf-items-count'; Argument: oaRequired),
  ...
  begin
   case OptionNum of
    ...
    7 : OctreeMaxLeafItemsCount := StrToInt(Argument);
    8 : begin
    ...
    13: begin
         InfoWrite(
          {'0123456789012345678901234567890123456789012345678901234567890123456789012345' }
           ...
           '  --octree-max-leaf-items-count COUNT' +nl+
...
begin
 ...
 try
  ...
  scene := TVRMLFlatScene.Create(LoadAsVRML(SceneFilename, true), true);
  Writeln('done.');
  Writeln(scene.Info(true, false));

  { calculate SceneOctree }
  SceneOctree := scene.CreateTriangleOctree(
    OctreeMaxDepth, OctreeMaxLeafItemsCount, 'Building octree');
  ...
  { go ! }
  sceneOctree.DirectCollisionTestsCounter := 0;
  ProcessTimerBegin;
  ...
  Writeln(Format(
    ...
    [ RenderingTime,
      sceneOctree.DirectCollisionTestsCounter ]));
  case RTKind of
   rtkClassic: begin
	...
	[ Image.Width, Image.Height, FirstRow, PrimaryRaysCount,
	  ...
	  sceneOctree.DirectCollisionTestsCounter /  PrimaryRaysCount ]));
     end;
   rtkPathTracer: begin
	...
	[ Image.Width, Image.Height, FirstRow,
	  ...
	  sceneOctree.DirectCollisionTestsCounter /  PathsCount ]));
     end;
  end;
